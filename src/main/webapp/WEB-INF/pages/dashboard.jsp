...
<div class="row">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-info">
			<div class="inner">
				...
				<a href="${contextRoot}/measuring/equipment/customer/new-equipment.htm">
					<p>
						<span style="color: white;">Create New Equipment ID</span>
					</p>
				</a>
			</div>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			<div class="inner">
				<h3>2</h3>
				<a href="${contextRoot}/measuring/equipment/customer/update-equipment.htm">
					<p>
						<span style="color: white;">Update Equipment Calibration
							status</span>
					</p>
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-danger">
			<div class="inner">
				...
				<a href="#">
					<p>
						<span style="color: white;">View All Measuring Equipments</span>
					</p>
				</a>
			</div>
			<div class="icon">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-info">
			<div class="inner">
				...
				<a href="#">
					<p>
						<span style="color: white;">Calibration Expiry dues</span>
					</p>
				</a>
			</div>
			<div class="icon">
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-info">
			<div class="inner">
				...
				<a href="#">
					<p>
						<span style="color: white;">List of Missing and Rejected
							Equipments</span>
					</p>
				</a>
			</div>
